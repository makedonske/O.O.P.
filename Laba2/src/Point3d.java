...
//Если расстояние между точками разное
...
// Сравнение значений точек
    {
        return (a.getX() == b.getX()) && (a.getY() == b.getY()) && (a.getZ() ==
                b.getZ());
    }
...
// Нахождение расстояния между точками
    {
        double Round = Math.sqrt(sqr((b.getX()-a.getX())) + sqr((b.getY()-a.getY()))
                + sqr((b.getZ()-a.getZ())));
        Round *= 100;
        Round = (int) Round;
        return (Round / 100);
