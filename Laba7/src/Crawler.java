...
public class Crawler {
    ...
    public static void Process(String pair, int maxDepth) throws IOException {
        ...
        while (!findLink.isEmpty()) {
            ...
            if (currentPair.depth < maxDepth) {
                ...
                my_socket.setSoTimeout(1000); // устанавливает время ожидания сокета
                try {
                    BufferedReader in = new BufferedReader(new InputStreamReader(my_socket.getInputStream())); //возвращает InputStream, связанный с Socket
                    PrintWriter out = new PrintWriter(my_socket.getOutputStream(), true); // возвращает OutputStream, связанный с Socket
    ...
    public static void main(String[] args) {
        String[] arg = new String[]{"https://lifehacker.ru/","4"};
        try {
